...
import FoodImg1 from "../../assets/food3.png";
import FoodImg2 from "../../assets/food7.png";
import FoodImg3 from "../../assets/food2.png";
...
const Hero = () => {
  const [imageId, setImageId] = React.useState(FoodImg1);
        ...
        <div className="container pb-8 sm:pb-0">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            >
              ...
              <p className="text-sm ">
                The best restaurant in town for serving the most delicious food
              </p>
              <div>
